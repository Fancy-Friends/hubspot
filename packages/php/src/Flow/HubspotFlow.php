 ...
 */
/**
 * Every HubSpot node executor — the PHP twin of `HUBSPOT_RUNNABLE_KINDS` in
 * @particle-academy/hubspot-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `HubspotFlow::register($kinds, $executors)` — one call, no directory scan.
 ...
 */
final class HubspotFlow
{
    /** @var list<class-string> */
    public const EXECUTORS = [
        ContactCreateExecutor::class,
    ];
